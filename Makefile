...
LDFLAGS=--ldflags "-s -X github.com/morecup/rclone/fs.Version=$(TAG)"
...
test_all:
	go install $(LDFLAGS) $(BUILDTAGS) $(BUILD_ARGS) github.com/morecup/rclone/fstest/test_all
...
btest:
	@echo "[$(TAG)]($(BETA_URL)) on branch [$(BRANCH)](https://github.com/morecup/rclone/tree/$(BRANCH)) (uploaded in 15-30 mins)" | xclip -r -sel clip
	@echo "Copied markdown of beta release to clip board"

btesth:
	@echo "<a href="$(BETA_URL)">$(TAG)</a> on branch <a href="https://github.com/morecup/rclone/tree/$(BRANCH)">$(BRANCH)</a> (uploaded in 15-30 mins)" | xclip -r -sel clip -t text/html
